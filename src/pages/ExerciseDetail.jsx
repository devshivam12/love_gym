...
const ExerciseDetail = () => {
  ...
  useEffect(() => {
    const fetchExerciseData = async () => {
      ...
      const targetMuscleExercisData = await fetchData(`${exerciseDbUrl}/exercises/target/${exerciseDetailData.target}`, exerciseOptions);
      setTargetMuscleExercises(targetMuscleExercisData)
  ...
  return (
    <Box>
      ...
      <SimilarExercises
        ...
        equipmentExercises={equipmentMuscleExercises} />
    </Box>
  )
}
